...
for i in range(numero_de_snps):
  ...
  snp_nome = input("Insira o nome da snp(ex.:rs231231): ")
  snp_local = int(input("Insira o local da snp(ex.:44666777): "))
  #alguns dos atributos para o alelo
  snp_chrom = int(input("Insira o cromossomo da snp(ex.:14): "))
  snp_charact = input("Insira a caracteristica da snp(indel ou SNV): ")

  snp_ancestral = input("insira o alelo ancestral/wild-type: ")
  minor_allele = input("Insira o alelo minor: ")
  minor_allele.upper()
...
input_usuario_1 = input("Gostaria de saber se as snps estão dentro de elementos regulatórios (y/N): ")
...
input_usuario_2 = input("Gostaria de remover snps (y/N): ")
